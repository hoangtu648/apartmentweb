...
const FootballENG = () => {
  const { rssItems, loading, error } = useRssFeed(184);
  ...
  const checkSave = async (link) => {
    try {
      const response = await fetch(
        `http://localhost:8087/api/favorite/countFavoriteByAccountID?link=${link}&username=${currentUser.username}`,
        {
          method: "GET",
          headers: {
  ...
  const handleSaveClick = async (item) => {
    ...
    try {
      const response = await fetch(
        "http://localhost:8087/api/favorite/create",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
                                ...
                                <div className="col-xl-6 col-lg-6 col-md-6">
                                  <div className="whats-news-single mb-20">
                                    ...
                                    <div className="whates-caption whates-caption2">
                                      <h4>
                                        <Link
                                          to={`/news-details/${encodeURIComponent(
                                            item.link
                                          )}`}
                    ...
                    <ul className="list cat-list">
                      ...
                      <li>
                        <Link to="/football-euro" className="d-flex">
                          <p className="active">Bóng đá Châu Âu</p>
                        </Link>
                      </li>
                      <li>
